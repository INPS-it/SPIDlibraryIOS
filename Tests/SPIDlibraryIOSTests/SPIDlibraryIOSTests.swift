...
final class SPIDlibraryIOSTests: XCTestCase {
    ...
    let identityProviderKeys = IdentityProviderKeys(aruba: "aruba", etna: "etna", infocamere: "infocamere", infocert: "infocert", intesi: "intesi", lepida: "lepida", namirial: "namirial", poste: "poste", sielte: "sielte", spiditalia: "spiditalia", teamsystem: "teamsystem", tim: "tim")
